...
void LIS3DSH_init(PinName mosi, PinName miso, PinName clk, PinName cs) {
...
void LIS3DSH_WriteReg(uint8_t addr, uint8_t data) {
    _cs = 0;
...
void LIS3DSH_ReadData(int16_t *X, int16_t *Y, int16_t *Z) {
...
void LIS3DSH_ReadAngles(float *Roll, float *Pitch) {   
...
float LIS3DSH_gToDegrees(float V, float H) {
  float retval;
